(function(a){var l={panels:[],panelCounter:0,postsData:{},allowPanelImageResize:!0,init:function(){"single"===as_js_vars.page?this.initSingleAccordionPage():"all"===as_js_vars.page&&this.initAllAccordionsPage()},initSingleAccordionPage:function(){var b=this;this.initPanels();-1!==parseInt(as_js_vars.id,10)&&this.loadAccordionData();a("form").on("submit",function(a){a.preventDefault();b.saveAccordion()});a(".preview-accordion").on("click",function(a){a.preventDefault();b.previewAccordion()});a(".add-panel").on("click",
...
".preview-accordion",function(c){c.preventDefault();b.previewAccordionAll(a(this))});a(".accordions-list").on("click",".delete-accordion",function(c){c.preventDefault();b.deleteAccordion(a(this))});a(".accordions-list").on("click",".duplicate-accordion",function(c){c.preventDefault();b.duplicateAccordion(a(this))});a(".clear-all-cache").on("click",function(c){c.preventDefault();a(".clear-cache-spinner").css("display","inline-block");c=a(this).attr("data-nonce");a.ajax({url:as_js_vars.ajaxurl,type:"post",
data:{action:"accordion_slider_lite_clear_all_cache",nonce:c},complete:function(c){a(".clear-cache-spinner").css("display","")}})})},loadAccordionData:function(){var b=this;a(".panel-spinner").css("display","inline-block");a.ajax({url:as_js_vars.ajaxurl,type:"get",data:{action:"accordion_slider_lite_get_accordion_data",id:as_js_vars.id,nonce:as_js_vars.lad_nonce},complete:function(c){c=a.parseJSON(c.responseText);a.each(c.panels,function(c,e){var k={background:{},layers:e.layers,html:e.html,settings:a.isArray(e.settings)?
{}:e.settings};a.each(e,function(a,c){-1!==a.indexOf("background")&&(k.background[a]=c)});b.getPanel(c).setData("all",k)});a(".panel-spinner").css("display","")}})},saveAccordion:function(){var b=this.getAccordionData();b.nonce=as_js_vars.sa_nonce;b.action="save";var b=JSON.stringify(b),c=a(".update-spinner").css("display","inline-block");a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_save_accordion",data:b},complete:function(b){c.css("display","");-1===parseInt(as_js_vars.id,
10)&&!1===isNaN(b.responseText)?(a("h2").after('<div class="updated"><p>'+as_js_vars.accordion_create+"</p></div>"),window.location=as_js_vars.admin+"?page=accordion-slider-lite&id="+b.responseText+"&action=edit"):0===a(".updated").length&&a("h2").after('<div class="updated"><p>'+as_js_vars.accordion_update+"</p></div>")}})},getAccordionData:function(){var b=this,c={id:as_js_vars.id,name:a("input#title").val(),settings:{},panels:[],panels_state:{}};a(".panels-container").find(".panel").each(function(f){var e=
...
a.lightURLParse(b.attr("href"));b=c.lad_nonce;c=parseInt(c.id,10);a.ajax({url:as_js_vars.ajaxurl,type:"get",data:{action:"accordion_slider_lite_get_accordion_data",id:c,nonce:b},complete:function(b){b=a.parseJSON(b.responseText);h.open(b)}})},deleteAccordion:function(b){var c=a.lightURLParse(b.attr("href")),f=c.da_nonce,e=parseInt(c.id,10),k=b.parents("tr"),d=a('<div class="modal-overlay"></div><div class="modal-window-container">\t<div class="modal-window delete-accordion-dialog">\t\t<p class="dialog-question">'+
as_js_vars.accordion_delete+'</p>\t\t<div class="dialog-buttons">\t\t\t<a class="button dialog-ok" href="#">'+as_js_vars.yes+'</a>\t\t\t<a class="button dialog-cancel" href="#">'+as_js_vars.cancel+"</a>\t\t</div>\t</div></div>").appendTo("body");a(".modal-window-container").css("top",a(window).scrollTop());d.find(".dialog-ok").one("click",function(b){b.preventDefault();a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_delete_accordion",id:e,nonce:f},complete:function(a){e===
parseInt(a.responseText,10)&&k.fadeOut(300,function(){k.remove()})}});d.remove()});d.find(".dialog-cancel").one("click",function(a){a.preventDefault();d.remove()});d.find(".modal-overlay").one("click",function(a){d.remove()})},duplicateAccordion:function(b){var c=a.lightURLParse(b.attr("href"));b=c.dua_nonce;c=parseInt(c.id,10);a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_duplicate_accordion",id:c,nonce:b},complete:function(b){a(b.responseText).appendTo(a(".accordions-list tbody")).hide().fadeIn()}})},
...
this.panelCounter);a.attr("data-position",this.panelCounter);this.panelCounter++},getPanel:function(b){var c;a.each(this.panels,function(a,e){if(e.id===b)return c=e,!1});return c},duplicatePanel:function(b){var c=this,f=a.extend(!0,{},b);a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_add_panels",data:JSON.stringify([{settings:{content_type:f.settings.content_type},background_source:f.background.background_source}])},complete:function(b){b=a(b.responseText).appendTo(a(".panels-container"));
c.initPanel(b,f)}})},deletePanel:function(b){var c=this,f=c.getPanel(b),e=a('<div class="modal-overlay"></div><div class="modal-window-container">\t<div class="modal-window delete-panel-dialog">\t\t<p class="dialog-question">'+as_js_vars.panel_delete+'</p>\t\t<div class="dialog-buttons">\t\t\t<a class="button dialog-ok" href="#">'+as_js_vars.yes+'</a>\t\t\t<a class="button dialog-cancel" href="#">'+as_js_vars.cancel+"</a>\t\t</div>\t</div></div>").appendTo("body");a(".modal-window-container").css("top",
...
background_width:b.width,background_height:b.height,background_link:b.link})});a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_add_panels",data:JSON.stringify(f)},complete:function(c){var d=a(".panels-container").find(".panel").length-1;a(".panels-container").append(c.responseText).find(".panel"+(-1===d?"":":gt("+d+")")).each(function(c){var d=a(this);b.initPanel(d,{background:f[c],layers:{},html:"",settings:{}})})}})})},showInfo:function(b){var c=b.attr("data-info"),
...
accordion:null,accordionData:null,open:function(b){this.accordionData=b;var c=this,d=a(".preview-spinner").css("display","inline-block");a.ajax({url:as_js_vars.ajaxurl,type:"post",data:{action:"accordion_slider_lite_preview_accordion",data:JSON.stringify(b)},complete:function(b){a("body").append(b.responseText);c.init();d.css("display","")}})},init:function(){var b=this;a(".modal-window-container").css("top",a(window).scrollTop());this.previewWindow=a(".preview-window .modal-window");this.accordion=
this.previewWindow.find(".accordion-slider");this.previewWindow.find(".close-x").on("click",function(a){b.close()});var c=this.accordionData.settings.width,d=this.accordionData.settings.height,e=-1!==c.indexOf("%"),h=-1!==d.indexOf("%");!0===e?this.accordion.accordionSlider("width","100%"):c=parseInt(c,10);!0===h&&this.accordion.accordionSlider("height","100%");a(window).on("resize.accordionSlider",function(){!0===e?b.previewWindow.css("width",a(window).width()*(parseInt(c,10)/100)-100):c>=a(window).width()-
100?b.previewWindow.css("width",a(window).width()-100):b.previewWindow.css("width",c);!0===h&&b.previewWindow.css("height",a(window).height()*(parseInt(d,10)/100)-200)});a(window).trigger("resize");a(window).trigger("resize")},close:function(){this.previewWindow.find(".close-x").off("click");a(window).off("resize.accordionSlider");this.accordion.accordionSlider("destroy");a("body").find(".modal-overlay, .modal-window-container").remove()}};a(document).ready(function(){l.init()})})(jQuery);
